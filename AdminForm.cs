...
namespace Project
{
    public partial class AdminForm : Form
    {
        ...
        #endregion
        #region top panel
        private void StylePanelAndLabels()
        {
            // Styling for the panel
            panel1.BackColor = Color.White; // Set panel background color
            panel1.Height = 30; // Set panel height

            // Styling for the "Close" label
            labelClose.Text = "X"; // Set label text
            labelClose.ForeColor = Color.Red; // Set text color
            labelClose.Font = new Font("Arial", 12, FontStyle.Bold); // Set font
            labelClose.Location = new Point(panel1.Width - 30, 7); // Position label to the right side
            labelClose.Cursor = Cursors.Hand; // Change cursor when hovering over the label

            // Styling for the "Minimize" label
            labelMinimize.Text = "-"; // Set label text
            labelMinimize.ForeColor = Color.Black; // Set text color
            labelMinimize.Font = new Font("Arial", 12, FontStyle.Bold); // Set font
            labelMinimize.Location = new Point(panel1.Width - 60, 7); // Position label next to the "Close" label
            labelMinimize.Cursor = Cursors.Hand; // Change cursor when hovering over the label

            // Styling for the "Admin Panel" label
            labelAdminPanel.Text = "Admin Panel"; // Set label text
            labelAdminPanel.ForeColor = Color.Black; // Set text color
            labelAdminPanel.Font = new Font("Arial", 14, FontStyle.Bold); // Set font
            labelAdminPanel.Location = new Point(10, 7); // Position label on the left side
        }
        ...
        {
            // Minimize the application when the "Minimize" label is clicked
